      ...
      <div className="flex flex-col items-center gap-4 mb-8 text-center">
        ...
        <div>
          <h1 className="text-xl font-extrabold tracking-tight">
            {t('workspace.welcome')} <span className="text-blue-500">{userName}</span>
          </h1>
        ...
        {lastWorkspacePath && (
          ...
          >
            ...
            <div className="text-left flex-1 min-w-0">
              <p className="text-[10px] text-slate-500 font-semibold uppercase tracking-wider">{t('workspace.recentLabel')}</p>
