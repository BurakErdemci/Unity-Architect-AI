...
const tr = {
  ...
  'usage.tokensTitle': 'Bu sohbet açıldığından beri: {giris} giriş + {cikis} çıkış token, {tur} tur.\nUygulama kapanınca sıfırlanır.',
  'usage.noTokens': 'Bu model token bilgisi bildirmiyor',
  'usage.costTitle': 'Bilinen maliyet: {tutar}. Yalnız maliyet bildiren turlar toplanıyor.',
  ...
  'models.notInAccount': 'hesapta yok',
  'models.notInAccountTitle': 'Sağlayıcı bu modeli hesabına açık modeller arasında saymadı. Yine de deneyebilirsin.',
  'models.liveOnly': 'yeni',
  'models.liveOnlyTitle': 'Bu model sağlayıcının canlı listesinden geldi; uygulamanın kendi kataloğunda yok.',
...
const en: Record<keyof typeof tr, string> = {
  ...
  'usage.tokensTitle': 'Since this chat was opened: {giris} input + {cikis} output tokens over {tur} turns.\nResets when the app restarts.',
  'usage.noTokens': 'This model does not report token counts',
  'usage.costTitle': 'Known cost: {tutar}. Only turns that report a cost are added up.',
  'report.button': 'Usage',
  ...
  'models.noKey': 'no key',
  'models.notInAccount': 'not in account',
  'models.notInAccountTitle': 'The provider did not list this model for your account. You can still try it.',
  'models.liveOnly': 'new',
  'models.liveOnlyTitle': 'This model came from the provider\'s live list; the app\'s own catalogue does not have it.',
