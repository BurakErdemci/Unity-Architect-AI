...
@mcp_for_unity_tool(
    ...
    description=(
        ...
        "buttons are held, cached stick/trigger values, the project's Active Input Handling "
        "setting, and playMode.frameCount. START HERE when input seems ignored. Safe to call "
        "outside play mode. If the game looks unresponsive, call describe TWICE and compare "
        "playMode.frameCount: if it does not advance the engine is frozen, not the input path — "
        "and no focus flag will tell you that.\n"
