    ...
    async def get_available_models():
        models = {
            ...
            "cloud": [
                ...
                {"id": "gemini-2.5-flash",              "name": "Gemini 2.5 Flash",      "provider": "google", "openrouter_id": "google/gemini-2.5-flash"},
                {"id": "gemini-2.5-flash-lite",         "name": "Gemini 2.5 Flash Lite", "provider": "google", "openrouter_id": "google/gemini-2.5-flash-lite"},
                {"id": "gemini-2.5-pro",                "name": "Gemini 2.5 Pro",        "provider": "google", "openrouter_id": "google/gemini-2.5-pro"},
